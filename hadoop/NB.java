...
public class NB
{
    ...
    public static class Map_Training extends Mapper<Object, Text, Text, Text> 
    {
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException 
        {
            ...
            String tweet_sentiment = columns[8];
            String tweet_text = columns[2];
            ...
            if(tweet_sentiment.equals("POSITIVE"))
            {
    ...
    public static class Map_Testing extends Mapper<Object, Text, Text, Text> 
    {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException 
        {
            ...
            {
                if(tweet_sentiment.equals("NEGATIVE"))
